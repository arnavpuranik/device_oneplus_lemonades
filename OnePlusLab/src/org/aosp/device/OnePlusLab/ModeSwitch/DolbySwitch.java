 ...
 */
package org.aosp.device.OnePlusLab.ModeSwitch;
...
public class DolbySwitch {
    ...
    public void setEnabled(boolean enabled) {
        ...
        if (enabled) {
            ...
            mContext.startServiceAsUser(daxService, UserHandle.SYSTEM);
            return;
        }
        // disable service component and stop service
        mContext.stopServiceAsUser(daxService, UserHandle.SYSTEM);
        mContext.getPackageManager().setComponentEnabledSetting(mComponentName,
