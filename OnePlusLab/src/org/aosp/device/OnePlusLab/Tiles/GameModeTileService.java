...
public class GameModeTileService extends TileService {
    ...
    public void onStartListening() {
        ...
        getQsTile().setState(OnePlusLab.isGamingModeSupported() && GameModeSwitch.isSupported() ? (enabled ? Tile.STATE_ACTIVE : Tile.STATE_INACTIVE) : Tile.STATE_UNAVAILABLE);
    ...
    public void onClick() {
        ...
        SharedPreferences sharedPrefs = PreferenceManager.getDefaultSharedPreferences(this);
        enabled = GameModeSwitch.isCurrentlyEnabled(this);
        FileUtils.writeLine(GameModeSwitch.getFile(), enabled ? "0" : "1");
